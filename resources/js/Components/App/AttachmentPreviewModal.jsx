...
import {ChevronRightIcon, PaperClipIcon, XMarkIcon} from "@heroicons/react/16/solid";
                    ...
                    <div className="fixed inset-0 overflow-y-auto">
                        <div className="h-screen w-screen">
                            <Transition.Child
                              ...
                              leaveTo="opacity-0 translate-y-4 sm:translate-y-0 sm:sclae-95"
                            >
                                <Dialog.Panel
                                  className="flex flex-col w-full transform overflow-hidden bg-slate-100
                                    ...
                                    <div className="relative group h-full">
                                        {
                                            currentIndex > 0 && (
                                                <div
                                                  ...
                                                  flex items-center justidy-center w-16 h-16 left-4 top-1/2 -translate-y-1/2
                                        ...
                                        {
                                            attachment && (
                                                <div className="flex items-center justify-center w-fu;; h-full p-3">
                                                    {
                                                        isImage(attachment) && (
